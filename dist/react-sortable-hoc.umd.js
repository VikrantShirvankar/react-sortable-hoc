	  ...
	  return _temp = _class = function (_Component) {
	      ...
	      defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePress", function (event) {
	        ...
	        if (active) {
	          ...
	          if (helperClass) {
	            ...
	            (_this$helper$classLis = _this.helper.classList).add.apply(_this$helper$classLis, toConsumableArray(helperClass.split(' ')));
	          }
	    ...
	    createClass(_class, [{
	      ...
	      value: function animateNodes() {
	        ...
	        for (var i = 0, len = nodes.length; i < len; i++) {
	          ...
	          if (transitionDuration) {
	            node.style["".concat(vendorPrefix, "TransitionDuration")] = "".concat(transitionDuration, "ms");
	          }
	          ...
	          if (this.axis.x) {
	            if (this.axis.y) {
	              if (index < this.index && (sortingOffset.left + windowScrollDelta.left - offset.width <= edgeOffset.left && sortingOffset.top + windowScrollDelta.top <= edgeOffset.top + offset.height || sortingOffset.top + windowScrollDelta.top + offset.height <= edgeOffset.top)) {
	                ...
	                if (nextNode && edgeOffset.left + translate.x > this.containerBoundingRect.width - offset.width) {
	                ...
	                if (prevNode && edgeOffset.left + translate.x < this.containerBoundingRect.left + offset.width) {
	          ...
	          node.style["".concat(vendorPrefix, "Transform")] = "translate3d(".concat(translate.x, "px,").concat(translate.y, "px,0)");
	        }
	      ...
	      value: function render() {
	        ...
	        return React__default.createElement(WrappedComponent, _extends_1({
	          ref: ref
